...
namespace SeleniumProject.Function
{
	public class Script : ScriptingInterface.IScript
	{
		...
		public void Execute(DriverManager driver, TestStep step)
		{
			...
			//"BOWLS", "TOP 25", 
			string[] expectedConf = {"BOWLS", "TOP 25", "FBS (I-A)", "AAC", "ACC", "BIG 12", "BIG SKY", "BIG SOUTH", "BIG TEN", "C-USA", "CAA", "IND-FBS", "IND-FCS", "IVY", "MAC", "MEAC", "MVC", "MW", "NEC", "OVC", "PAC-12", "PATRIOT LEAGUE", "PIONEER", "SEC", "SOUTHERN", "SOUTHLND", "SUN BELT", "SW ATH"};
