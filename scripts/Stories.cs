			...
			if (step.Name.Equals("Click Arrow Forward to End of Carousel")) {
				...
				switch(step.Data) {
					...
					case "NBA":
						...
						string[] nba_players = {"LEBRON JAMES", "KEVIN DURANT", "JAMES HARDEN", "KYRIE IRVING", "LAMELO BALL", "ANDRE IGUODALA", "DRAYMOND GREEN", "ZION WILLIAMSON", "JALEN SUGGS", "LUKA DONCIC"};
